...
public class StepModuloTransporteCasoAltoG4 {
    ...
    public void ingreso_al_modulo_de_vuelo() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("Se cierra ventana emergente de suscribir")
    public void se_cierra_ventana_emergente_de_suscribir() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void escribo_en_la_casilla_lugar_de_destino_de_traslado(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("Selecciono con un click el la fecha de recogida")
    public void selecciono_con_un_click_el_la_fecha_de_recogida() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("Selecciono con un click la hora de recogida")
    public void selecciono_con_un_click_la_hora_de_recogida() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("Selecciono el numero de pasajeros con un click {string}")
    public void selecciono_el_numero_de_pasajeros_con_un_click(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("Click en el botono {string}")
    public void click_en_el_botono(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void click_boton_reserva_ahora() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
