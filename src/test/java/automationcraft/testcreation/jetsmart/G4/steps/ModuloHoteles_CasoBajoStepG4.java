...
public class ModuloHoteles_CasoBajoStepG4 {

    @Given("un usuario que ingresa a la pagina JetSmart")
    public void un_usuario_que_ingresa_a_la_pagina_jet_smart() {
    ...
    public void selecciona_fecha_de_vuelta_dias_a_la_fecha(Integer int1) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("selecciona numero de habitaciones {string}")
    public void selecciona_numero_de_habitaciones(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
